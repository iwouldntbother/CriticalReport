...
<!-- While this isn't the case for all "Powered by AI" products, some products that claim AI use are simply powered by a mass of underpaid humans in 3rd world countries. Even tech giant Amazon caught slack for this exact issue, their so claimed "Just walk out" technology, labelled as such due to its use of computer-vision, sensors and AI, shoppers were able to pick up items in their Amazon Fresh stores and just walk out. Having the tech watch them and calculate what they had bought to charge them. What they failed to mention is the ~1000 people employed in India to manually check nearly 70% of the footage. [Citation needed]

This isn't exclusive to large, well established companies. Delphia Inc. and Global Predictions Inc., both investment firms, have agreed to pay a combined $400,000 to settle charges made by the Securities and Exchange Commission (SEC) due to their "false and misleading statements about their use of Artificial Intelligence". -->
